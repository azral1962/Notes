...
Tabel ini membantu memperjelas lingkungan sebagai ruang dampak, inspirasi, dan jejak ekologis. Dalam konteks pembahasan 2.5 Environment (Lingkungan), tabel berfungsi sebagai jembatan antara uraian konseptual dan representasi terstruktur yang siap dipakai untuk analisis, perancangan ontologi, atau simulasi. Karena itu, tabel sebaiknya ditempatkan segera setelah pengantar konsep pada section ini agar pembaca mendapat kerangka ringkas sebelum masuk ke uraian lanjutan.
...
-   **Perluasan Metrik Pengukuran di Masa Depan:** Untuk perancangan artefak cerdas yang lebih komprehensif ke depannya, kerangka kerja ini menyarankan agar pengukuran Energi Layanan diperluas. Metrik yang diusulkan untuk mengkuantifikasi dimensi ini meliputi **pengukuran tingkat keandalan sistem (MTBF -** **Mean Time Between Failures****), indeks kenyamanan pengguna, hingga seberapa mudah layanan tersebut dapat diakses (****accessibility****) oleh beragam kelompok demografi** [@smart_engineering_framework].
...
Deskripsi gambar: Gambar berupa sketsa tiga moda transportasi berdampingan. dalam gaya sketsa pena hitam di atas latar putih, sederhana, bersih, dan mudah dibaca.

Prompt Nano Banana Pro: "Buat ilustrasi line-art sederhana dengan latar putih polos dan garis pena hitam tipis. Topik: Sketsa tiga moda transportasi berdampingan. untuk section '12.2 Evaluasi Fleet EV vs Bus vs Kereta Cepat'. Komposisi bersih, minimalis, tanpa shading berat, tanpa warna, tanpa tekstur latar, tanpa detail realistis yang rumit. Gunakan ikon, panah, label singkat, dan bentuk geometris sederhana agar cocok untuk buku akademik teknik."
-->
...
Deskripsi gambar: Gambar berupa sketsa tiga sumbu evaluasi: waktu, biaya, emisi. dalam gaya sketsa pena hitam di atas latar putih, sederhana, bersih, dan mudah dibaca.

Prompt Nano Banana Pro: "Buat ilustrasi line-art sederhana dengan latar putih polos dan garis pena hitam tipis. Topik: Sketsa tiga sumbu evaluasi: waktu, biaya, emisi. untuk section '12.3 Metrik: Waktu, Biaya, Emisi CO2'. Komposisi bersih, minimalis, tanpa shading berat, tanpa warna, tanpa tekstur latar, tanpa detail realistis yang rumit. Gunakan ikon, panah, label singkat, dan bentuk geometris sederhana agar cocok untuk buku akademik teknik."
-->