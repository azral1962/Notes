...
```{=typst}
#figure(
  image("slide.pdf", page: 1, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 2, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 3, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 4, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 5, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 6, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 7, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 8, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 9, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 10, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 11, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 12, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 13, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 14, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 15, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 16, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 17, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 18, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 19, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 20, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 21, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 22, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 23, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 24, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 25, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 26, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 27, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 28, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 29, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 30, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 31, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 32, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 33, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 34, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 35, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 36, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 37, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 38, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 39, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 40, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 41, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 42, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 43, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 44, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 45, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 46, width: 80%),
...
```{=typst}
#figure(
  image("slide.pdf", page: 47, width: 80%),
