...
position: bottom, 
[
Minard's map of Napoleon's Russian campaign, described by Edward Tufte as "may well be the best statistical graphic ever drawn" #margincite(<Tufte:vdqi>, "AuthorInText", "", "dy.-11cm", none, none).
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
...
<arbitrary-margin-content>
You can include anything in the margin by places the class #NormalTok(".column-margin"); on the element. See an example on the right about the first fundamental theorem of calculus.
...
<arbitrary-full-width-content>
Any content can span to the full width of the page, simply place the element in a #NormalTok("div"); and add the class #NormalTok("column-page-right");. For example, the following code will display its contents as full width.

#Skylighting(([#NormalTok("::: {.fullwidth}");],
[#NormalTok("Any _full width_ content here.");],
[#NormalTok(":::");],));
...
- Mickaël Canouil (#NormalTok("@mcanouil"););
- Gordon Woodhull (#NormalTok("@gordonwoodhull"););
- Charles Teague (#NormalTok("@dragonstyle"););
- Raniere Silva (#NormalTok("@rgaiacs");); and
- Christophe Dervieux (#NormalTok("@cderv");)
- #NormalTok("@pgsuper");
