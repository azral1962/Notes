...
\author{
\thanks{Manuscript created May, 2026.}
...
% The paper headers
\markboth{IEEE Transactions on Technology and Society, Month Year}{T.
Gantini et.al.: GRACE: Ecosystem for Elderly}
...
\IEEEPARstart{P}{opulation} aging is reshaping healthcare, labor, family
structures, and public services. In response, digital systems for older
adults have grown rapidly, especially in telehealth, remote monitoring,
medication support, and care coordination. These systems are valuable,
but many are built around narrow assumptions: that old age is primarily
a condition of decline, risk, and dependency.
...
\caption{\label{tbl-panel2}Main Caption}

\begin{minipage}[t]{\linewidth}

\subcaption{\label{tbl-first-tbl-colwidths2026-26-26}First Table}
...
orientation & peace, meaning, hope, acceptance, moral
continuity & reflection prompts, prayer/meditation support, ritual
reminders, grief-sensitive dialogue\\
Family and Friends & Intimate and enduring personal
relationships & belonging, affection, care continuity, emotional
security, shared memory & family coordination, message prompts, memory
sharing, visit planning\\
Working Colleagues & Ongoing or legacy vocational and professional
ties & role continuity, usefulness, recognition, mentoring, productive
...
\caption{\label{tbl-wrapped}A nicely wrapped table using kableExtra}

\centering{

\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{5em}|>{\raggedright\arraybackslash}p{6.5em}|>{\raggedright\arraybackslash}p{6.5em}|>{\raggedright\arraybackslash}p{6.5em}}
\hline
Doman & Description & Functions & Examples\\
\hline
Very long introductory sentence that will wrap & Another long explanation for a completely different scenario. & Very long introductory sentence that will wrap & Another long explanation for a completely different scenario.\\
\hline
Short text & Simple detail & Short text & Simple detail\\
\hline
\end{tabular}
...
\caption{\label{tbl-domain}Domain, description, wellbuing functions, adn
examples system supports.}
...
file is intended to serve as a ``sample article file'' for IEEE journal
papers produced with (Pandoc/Quarto)-Markdown using
\texttt{IEEEtran.cls} version 1.8b and later for the PDF output. It is
based on \texttt{bare\_jrnl\_new\_sample4.tex} provided by IEEE
