...
First Author\orcidlink{0000-0001-9430-6091},~\IEEEmembership{Senior
Member, IEEE}
and~Second Author%
\thanks{First Author is with Departmen, First
Institution, City, 18800 Country%
  Corresponding author: usernname@ieee.org
}
\thanks{Second Institution}
%by-author.affiliations
\thanks{Second Author is with Anonymous University%
}
%by-author.affiliations
...
\textbf{Index Terms---} aging, wellbeing, narrative identity, multiagent
...
\pagebreak[3]
\begin{IEEEbiography}[\includegraphics{david-folio.png}]{First Author}
