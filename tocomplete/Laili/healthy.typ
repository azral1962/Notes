...
#figure([
#box(image("healthy_files/figure-latex/mermaid-figure-1.png"))
...
<evidence-map-20-key-papers>
+ #strong[Bondevik et al.~(2024), #emph[A systematic review on food recommender systems]]. #emph[Stream:] Food RS. #emph[Aim:] Review the food recommender field. #emph[Method:] Systematic review. #emph[Main finding:] Food recommenders are mature but fragmented across methods and goals. #emph[Why it matters:] High-level overview of food RS.
+ #strong[Tran et al.~(2018), #emph[An overview of recommender systems in the healthy food domain]]. #emph[Stream:] Healthy food RS. #emph[Aim:] Survey healthy-food recommenders. #emph[Method:] Technical review. #emph[Main finding:] Healthy-food RS must balance preference, nutrition, and behavior change. #emph[Why it matters:] Foundation for healthy recommendation logic.
+ #strong[Trattner & Elsweiler (2017), #emph[Food Recommender Systems: Important Contributions, Challenges and Future Research Directions]]. #emph[Stream:] Food RS. #emph[Aim:] Summarize contributions and challenges. #emph[Method:] Scholarly survey. #emph[Main finding:] Food RS differ from generic RS due to health and context. #emph[Why it matters:] Seminal conceptual framing.
+ #strong[Ge et al.~(2015), #emph[Health-aware Food Recommender System]]. #emph[Stream:] Healthy food RS. #emph[Aim:] Introduce a health-aware recommender. #emph[Method:] Conference system paper. #emph[Main finding:] Health can be embedded in recommendation logic. #emph[Why it matters:] Early nutrition-aware system.
+ #strong[Rostami et al.~(2024), #emph[A novel healthy food recommendation to user groups…]]. #emph[Stream:] Healthy food RS. #emph[Aim:] Move from individual to group recommendation. #emph[Method:] Model + experiments. #emph[Main finding:] Group recommendation is feasible in food contexts. #emph[Why it matters:] Relevant for shared dining settings.
+ #strong[Wang et al.~(2024), #emph[Improving healthy food recommender systems through heterogeneous hypergraph learning]]. #emph[Stream:] Healthy food RS. #emph[Aim:] Improve recommendation accuracy. #emph[Method:] ML model. #emph[Main finding:] Richer user-food-ingredient modeling improves personalization. #emph[Why it matters:] Useful for technical engine design.
+ #strong[Workplace explanation study (2025)]. #emph[Stream:] Explainability. #emph[Aim:] Study explanations in deployment. #emph[Method:] User-centered deployment study. #emph[Main finding:] Explanations improve understanding and control. #emph[Why it matters:] Relevant for trust and adoption.
+ #strong[Tsolakidis et al.~(2024), #emph[AI and ML Technologies for Personalized Nutrition: A Review]]. #emph[Stream:] Personalized nutrition. #emph[Aim:] Review AI/ML for nutrition. #emph[Method:] Review. #emph[Main finding:] Personalized nutrition is increasingly recommender-driven. #emph[Why it matters:] Bridge to nutrition science.
+ #strong[Zheng (2017), #emph[Multi-Stakeholder Recommendation: Applications and Challenges]]. #emph[Stream:] MSR. #emph[Aim:] Define MSR and agenda. #emph[Method:] Conceptual paper. #emph[Main finding:] Recommendation involves multiple legitimate utilities. #emph[Why it matters:] Core theory.
+ #strong[Abdollahpouri & Burke (2019), #emph[Multi-stakeholder Recommendation and its Connection to Multi-sided Fairness]]. #emph[Stream:] MSR. #emph[Aim:] Connect MSR with fairness. #emph[Method:] Conceptual paper. #emph[Main finding:] Fairness is central in multi-stakeholder settings. #emph[Why it matters:] Governance foundation.
+ #strong[Wu et al.~(2021), #emph[Multi-FR]]. #emph[Stream:] Fairness-aware RS. #emph[Aim:] Optimize across stakeholder interests. #emph[Method:] Multi-objective framework. #emph[Main finding:] Multi-objective optimization can balance utilities. #emph[Why it matters:] Strong precedent for scoring models.
+ #strong[Burke et al.~(2018), #emph[Balanced neighborhoods for multi-sided fairness in recommendation]]. #emph[Stream:] Fairness-aware RS. #emph[Aim:] Improve fairness in exposure. #emph[Method:] Fairness-aware method. #emph[Main finding:] Rankings can reduce one-sided bias. #emph[Why it matters:] Relevant for equitable food exposure.
+ #strong[Tran et al.~(2021), #emph[Recommender systems in the healthcare domain]]. #emph[Stream:] Health RS. #emph[Aim:] Review healthcare RS. #emph[Method:] State-of-the-art review. #emph[Main finding:] Food RS fit within digital health RS. #emph[Why it matters:] Useful positioning paper.
+ #strong[Roy et al.~(2015), #emph[Food environment interventions in tertiary education settings]]. #emph[Stream:] Campus food. #emph[Aim:] Review interventions. #emph[Method:] Systematic review. #emph[Main finding:] Tertiary food interventions can improve choices. #emph[Why it matters:] Strong campus evidence.
+ #strong[Deliens et al.~(2014), #emph[Determinants of eating behaviour in university students]]. #emph[Stream:] Campus food. #emph[Aim:] Identify drivers of eating behavior. #emph[Method:] Qualitative study. #emph[Main finding:] Taste, convenience, peers, price, and availability matter. #emph[Why it matters:] Supports context-aware design.
+ #strong[Caruso et al.~(2025), #emph[The campus food environment and postsecondary student diet]]. #emph[Stream:] Campus food. #emph[Aim:] Review links between campus environment and diet. #emph[Method:] Systematic review. #emph[Main finding:] Campus food environments influence diet. #emph[Why it matters:] Supports ecosystem framing.
+ #strong[Dahl et al.~(2024), #emph[Assessing the Healthfulness of University Food Environments]]. #emph[Stream:] Campus food / measurement. #emph[Aim:] Review methods and tools. #emph[Method:] Systematic review. #emph[Main finding:] Assessment methods are heterogeneous. #emph[Why it matters:] Useful for KPI design.
+ #strong[Peixoto et al.~(2026), #emph[Sustainability in university restaurants]]. #emph[Stream:] Sustainability. #emph[Aim:] Map strategies in university restaurants. #emph[Method:] Scoping review. #emph[Main finding:] Research is still waste-centric. #emph[Why it matters:] Reveals gap for integration.
+ #strong[Guimarães et al.~(2024), #emph[Plate Food Waste in Food Services]]. #emph[Stream:] Operations / waste. #emph[Aim:] Quantify plate waste. #emph[Method:] Systematic review + meta-analysis. #emph[Main finding:] Food waste is measurable and significant. #emph[Why it matters:] Useful for canteen objectives.
+ #strong[#emph[Recommender systems and sustainability: a dual perspective] (2026)]. #emph[Stream:] Sustainability + RS. #emph[Aim:] Review sustainability in RS. #emph[Method:] Literature review. #emph[Main finding:] Sustainability should be both outcome and design principle. #emph[Why it matters:] Relevant for environmental objectives.
...
<simulation-experiment-design>
- #strong[Objective]: Evaluate whether an MSRS-enabled campus food ecosystem improves health, taste, affordability, efficiency, and sustainability relative to baseline systems. #emph[Rationale:] Tests ecosystem-level value of MSRS.
- #strong[Model type]: Hybrid #strong[ABM + DES + SD]. #emph[Rationale:] Captures heterogeneous actors, operational events, and long-term feedback.
- #strong[Unit of analysis]: Campus food ecosystem over daily, weekly, and semester horizons. #emph[Rationale:] Supports both operational and strategic evaluation.
- #strong[Agents]: Consumers, canteens, suppliers, researchers, administrators. #emph[Rationale:] Represents multi-stakeholder behavior.
- #strong[Food entities]: Ingredients, recipes, prepared meals, served meals, leftovers, waste streams. #emph[Rationale:] Represents end-to-end food flow.
- #strong[Decision engine]: Forecasting + DSS + MSRS optimizer. #emph[Rationale:] Simulates coordinated decision support.
- #strong[Baseline scenario 1]: No recommender. #emph[Rationale:] Pure operational reference.
- #strong[Baseline scenario 2]: Consumer-only recommender. #emph[Rationale:] Compares against standard personalization.
- #strong[Baseline scenario 3]: Rule-based healthy menu planning. #emph[Rationale:] Compares against non-learning policy approach.
- #strong[Treatment scenario]: Full MSRS-enabled ecosystem. #emph[Rationale:] Main intervention condition.
- #strong[Time step]: Daily operational step; weekly planning cycle; semester evaluation. #emph[Rationale:] Matches food-service decision frequency.
- #strong[Demand conditions]: Low, medium, high volatility. #emph[Rationale:] Tests robustness to uncertainty.
- #strong[Budget conditions]: Low, medium, high consumer budget pressure. #emph[Rationale:] Tests affordability sensitivity.
- #strong[Supply conditions]: Stable supply vs disrupted supply. #emph[Rationale:] Tests resilience.
- #strong[Preference conditions]: Homogeneous vs heterogeneous taste-health preferences. #emph[Rationale:] Tests personalization value.
- #strong[Policy conditions]: Different subsidy levels and sustainability weights. #emph[Rationale:] Tests policy sensitivity.
- #strong[Consumer outcomes]: Healthy meal uptake, taste satisfaction, affordability compliance, recommendation acceptance, repeat purchase. #emph[Rationale:] Measures user-facing success.
- #strong[Operational outcomes]: Forecast accuracy, stockouts, wait time, capacity use, food waste. #emph[Rationale:] Measures efficiency and feasibility.
- #strong[Financial outcomes]: Margin, cost per meal, healthy meal revenue share, subsidy efficiency. #emph[Rationale:] Measures economic viability.
- #strong[Sustainability outcomes]: Carbon footprint per meal, local/seasonal sourcing rate, total waste, packaging waste. #emph[Rationale:] Measures environmental performance.
- #strong[Supplier outcomes]: Order variability, fill rate, lead-time reliability, spoilage. #emph[Rationale:] Measures upstream coordination.
- #strong[Governance outcomes]: Fair access, stakeholder utility balance, explainability/trust. #emph[Rationale:] Measures legitimacy and equity.
- #strong[Statistical analysis]: Multiple replications; confidence intervals; pairwise tests and multi-scenario comparison. #emph[Rationale:] Tests significance.
- #strong[Practical significance]: % improvement, effect sizes, relative gain vs baseline. #emph[Rationale:] Tests real usefulness.
- #strong[Trade-off analysis]: Pareto frontier across health, taste, price, and waste. #emph[Rationale:] Tests multi-objective superiority.
- #strong[Robustness analysis]: Stress tests under disruption, price shock, and demand shifts. #emph[Rationale:] Tests stability of improvements.
- #strong[Success criterion]: MSRS outperforms baselines on key KPIs without major loss to any stakeholder group. #emph[Rationale:] Demonstrates balanced value co-creation.
...
<illustrative-summary-table>
- #strong[Healthy meal uptake (%)]: No recommender: 31; Consumer-only recommender: 39; Rule-based planning: 42; Full MSRS ecosystem: 49.
- #strong[Taste satisfaction (1--5)]: No recommender: 3.9; Consumer-only recommender: 4.0; Rule-based planning: 3.8; Full MSRS ecosystem: 4.1.
- #strong[Meals within budget (%)]: No recommender: 68; Consumer-only recommender: 73; Rule-based planning: 75; Full MSRS ecosystem: 82.
- #strong[Forecast accuracy (%)]: No recommender: 74; Consumer-only recommender: 77; Rule-based planning: 81; Full MSRS ecosystem: 87.
- #strong[Food waste per 100 meals (kg)]: No recommender: 18.5; Consumer-only recommender: 16.9; Rule-based planning: 15.8; Full MSRS ecosystem: 13.9.
- #strong[Carbon footprint per meal (kg CO2e)]: No recommender: 2.40; Consumer-only recommender: 2.31; Rule-based planning: 2.20; Full MSRS ecosystem: 2.02.
- #strong[Supplier order variability index]: No recommender: 1.00; Consumer-only recommender: 0.94; Rule-based planning: 0.88; Full MSRS ecosystem: 0.76.
- #strong[Ecosystem performance score (0--100)]: No recommender: 56; Consumer-only recommender: 64; Rule-based planning: 69; Full MSRS ecosystem: 81.
