...
#block[
#box(image("intro_files\\figure-typst\\mermaid-figure-1.png", height: 2.9in, width: 2.13in))

]

]
#block[
#Skylighting(([#BuiltInTok("print");#NormalTok("(");#StringTok("\"Hello World\"");#NormalTok(")");],));
#block[
#Skylighting(([#NormalTok("Hello World");],));
]
]
= Summary
<summary>
